...
@Directive({
  ...
  providers: [
    { provide: MAT_INPUT_VALUE_ACCESSOR, useExisting: CurrencyFormatPipe },
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CurrencyFormatPipe),
      multi: true
    }
  ]
})
export class CurrencyFormatPipe implements ControlValueAccessor {
